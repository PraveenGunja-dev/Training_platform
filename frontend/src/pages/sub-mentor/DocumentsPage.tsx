...
import type { DocVisibility, Document } from '@/lib/types';
...
/* ── Page ────────────────────────────────────────────────────────────── */
export default function SubMentorDocumentsPage() {
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Documents in your assigned groups.</p>
          </div>
        </div>
        <Button
              ...
              <TableBody>
                {filtered.map(doc => (
                  <DocRow
                    key={doc.id}
                    doc={doc}
                    groupName={groupMap.get(doc.group_id) ?? doc.group_id}
