...
describe('useCan — read_only flag', () => {
  beforeEach(() => {
    vi.mocked(useAuthStore).mockReturnValue({ user: subMentorUser } as ReturnType<typeof useAuthStore>);
...
// ---------------------------------------------------------------------------
// SubMentorCalendar — cross-visibility
// ---------------------------------------------------------------------------

describe('SubMentorCalendar — cross-visibility', () => {
  beforeEach(() => {
    vi.mocked(useAuthStore).mockReturnValue({ user: subMentorUser } as ReturnType<typeof useAuthStore>);
  });
...
describe('ClassDetailPage — read_only mode', () => {
  ...
  it('does NOT render Edit Class button when read_only=true', async () => {
    const { default: SubMentorClassDetailPage } = await import('@/pages/sub-mentor/ClassDetailPage');
    render(React.createElement(SubMentorClassDetailPage));
...
describe('DashboardPage — cross-visibility chip', () => {
  ...
  it('shows chip when effective_can_view_all=true', async () => {
    ...
    render(React.createElement(SubMentorDashboardPage));
