                ...
                <div className="lp-brand" ref={panelRef}>
                    ...
                    <div className="lp-content">
                        ...
                        <div className="lp-brandmark">
                            <img src="/training/adani-logo-white.svg" alt="Adani" className="lp-bm-logo" />
                        ...
                        <div className="lp-form-box">
                            ...
                            <div className="lp-form-inner">
                                <div className="lp-fhead">
                                    <img src="/training/adani-logo.svg" alt="Adani" className="lp-logo-dark" />
                    ...
                    <div className="ls-center">
                        <div className="ls-ring-wrap">
                            ...
                            <div className="ls-inner">
                                <img src="/training/adani-logo-white.svg" alt="Adani" className="ls-logo-img" />
                            </div>
                        </div>
