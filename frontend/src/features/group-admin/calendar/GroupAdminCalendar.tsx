...
export function GroupAdminCalendar() {
  ...
  const { data, isFetching, isPending } = useQuery({
    queryKey: ['group-admin', 'calendar', dateRange.from, dateRange.to],
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden relative">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-semibold text-slate-800 text-sm">My Group's Classes</h2>
              <p className="text-xs text-slate-500">All scheduled sessions for your group</p>
            </div>
            {isFetching && (
